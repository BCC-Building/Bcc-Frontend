...
import { FaHardHat, FaRulerCombined, FaCheckCircle, FaArrowRight } from 'react-icons/fa';
    ...
    >
      ...
      <div style={{
        ...
        <img
          ...
          alt="Construction project portfolio"
          style={{
            width: '100%',
            height: '100%',
            objectFit: 'cover',
      ...
      <div style={{ position: 'relative', zIndex: 2, width: '100%', padding: '4rem 0' }}>
        <div className="container text-center">
          ...
          >
            Landmark Projects That Define Excellence
          </motion.h1>
          ...
          >
            Explore residential, commercial, infrastructure, and industrial work delivered with strong planning, sharp execution, and consistent site quality.
          </motion.p>
          ...
          >
            ...
            >
              <FaRulerCombined /> Explore Projects <FaArrowRight style={{ fontSize: '0.75rem' }} />
            </a>
            <Link
              to="/contact"
              style={{
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px', opacity: 0.7 }}>
              <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.7rem' }}>Our projects</span>
